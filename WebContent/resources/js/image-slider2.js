...
$(document).ready(function() {
	...
	$("#prev").on('click', function() {
		...
		if(currentimage > 11){
			document.getElementById('floatingimagetitleid').innerHTML = "التغير الزمني في الغطاء الخضري-المنطقة (هـ)";
		}else{
			document.getElementById('floatingimagetitleid').innerHTML = "التغير الزمني في الغطاء الخضري-المنطقة (و)";
		}
	});
